                        ...
                        if(code==200){
                            ...
                            if(result==true){
                                ...
                                for(var i=0;i<item.length;i++){
                                    ...
                                    table.rows[rowCount-1].cells[1].appendChild(document.createTextNode(item[i].credit));
                                    table.rows[rowCount-1].insertCell(5);
                                    table.rows[rowCount-1].cells[5].appendChild(document.createElement(a));
                                    a.href="/user/beforeEdit.do?id="+item[i].id;
                                    a.rel="external nofollow";
                                    a.innerHTML="修改";
                                    table.rows[rowCount-1].cells[5].appendChild(document.createElement(a));
                                    a.href="/user/delete.do?id="+item[i].id;
                                    a.rel="external nofollow";
                                    a.innerHTML="删除";
                                }
